...
public class MovimentoContaMapper {
    ...
    public static MovimentoContaDTO toDto(MovimentoConta e) {
        ...
        Integer contaId = Math.toIntExact((e.getContaBancaria() == null) ? null : e.getContaBancaria().getId());
    ...
    public static MovimentoConta toEntity(MovimentoContaDTO dto, Function<Integer, ContaBancaria> grupoResolver) {
        if (dto == null) return null;
        ContaBancaria grupo = (dto.getContaBancariaId() == null) ? null : grupoResolver.apply(dto.getContaBancariaId());
    ...
    public static void copyToEntity(MovimentoContaDTO dto, MovimentoConta target, Function<Integer, ContaBancaria> grupoResolver) {
        if (dto == null || target == null) return;
        ContaBancaria grupo = (dto.getContaBancariaId() == null) ? null : grupoResolver.apply(dto.getContaBancariaId());
